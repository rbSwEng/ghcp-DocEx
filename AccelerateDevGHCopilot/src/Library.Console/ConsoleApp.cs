...
using Library.Infrastructure.Data; // Add this at the top
...
public class ConsoleApp
{
    ...
    private readonly JsonData _jsonData; // Add this field
    ...
    async Task<ConsoleState> PatronDetails()
    {
        ...
        CommonActions options = CommonActions.SearchPatrons | CommonActions.Quit | CommonActions.Select |
                                CommonActions.RenewPatronMembership | CommonActions.SearchBooks;
